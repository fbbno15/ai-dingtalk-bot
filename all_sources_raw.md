...
## Hailuo AI 推出 **Hailuo Video Agent** 的测试版本

· 用户可用自然语言描述创意，系统自动生成高质量视频  
· 产品开发分为模板化、半定制和全自动三个阶段  
· 当前上线的是第一阶段，展示多样化风格与创作能力  
[详情链接](https://www.xiaohu.ai/c/xiaohu-ai/hailuo-ai-hailuo-video-agent)  
#AI资讯 #产品动态
...
· Kyutai STT 是专为实时语音转文字场景优化的开源模型，具备低延迟、高准确率和强并发处理能力  
· 内置语义级语音活动检测模块，通过语音内容和语调判断说话是否结束，提升对话自然度  
· 支持多平台实现，包括 PyTorch、Rust 和 MLX，以适应不同使用场景和需求  
[详情链接](https://www.xiaohu.ai/c/xiaohu-ai/kyutai-kyutai-stt)  
#AI资讯 #产品动态
